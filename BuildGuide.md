...
Below is the video build guide↓

https://www.youtube.com/watch?v=zEUvSC2t4i8

## はじめに
この度は、「kazu-laser.v2」をお買い上げいただきまして誠にありがとうございます。
...
| 部品名                 | 必要個数   |  主な購入先                          | 補足 |
|:---------------------|:--------|:----------------------------------|:-----------------------------------------------|
| BLE Micro Pro 昇圧回路付き                 | 1   | https://shop.yushakobo.jp/products/10737?_pos=2&_sid=a0383fdbf&_ss=r   |                         |
...
| 単四電池         | 2 | コンビニエンスストア等 | **リチウム乾電池ではない** 1.5V制の一般的な単4電池である事。（エネループ等の充電式電池はOK）  |
...
種類の確認は以下の部品です。
- リチウム乾電池を使っていない事(アルカリ乾電池,エネループ等の充電式電池は大丈夫です)
